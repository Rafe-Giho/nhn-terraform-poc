...
```powershell
$env:TF_VAR_nhncloud_user_name = "<NHN Cloud ID>"
$env:TF_VAR_nhncloud_tenant_id = "<tenant-id>"
$env:TF_VAR_nhncloud_password = "<api-password>"
$env:TF_VAR_nhncloud_auth_url = "https://api-identity-infrastructure.nhncloudservice.com/v2.0"
$env:TF_VAR_nhncloud_region = "KR1"
```
